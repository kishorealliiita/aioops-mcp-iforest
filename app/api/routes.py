...
from app.schemas.models import (
    MultiSourceTrainRequest, FeedbackRequest, MultiSourceStreamRequest,
    MetricsResponse, AnomalyResult, StreamResult
)
...
async def metrics(
    ad_service: AnomalyDetectionService = Depends(get_anomaly_detection_service),
...
async def stream_multi_source(
    request: MultiSourceStreamRequest, 
    ad_service: AnomalyDetectionService = Depends(get_anomaly_detection_service)
):
...
async def train_model(
    request: MultiSourceTrainRequest,
